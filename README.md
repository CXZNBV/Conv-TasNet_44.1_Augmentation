...
```python
$env:VCTK\_SOURCE\_DIR = "E:\Dataset_path\VCTK-2mix"   # VCTK path.
$env:VCTK\_DATA\_BASE = "D:\Conv-TasNet_44.1_Augmentation\data"    # Base directory for generated datasets.
```
